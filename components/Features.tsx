...
export default function Features() {
  return (
    <>
      <section id="gallery" className="section-divider border-t border-white/10 py-20">
        <div className="mx-auto max-w-6xl px-6">
          <Reveal className="grid items-center gap-10 md:grid-cols-[1.05fr_1fr]">
            <div>
            ...
            <div className="relative h-[360px] overflow-hidden rounded-sm border border-white/10 shadow-[0_25px_70px_rgba(0,0,0,0.4)]">
              <Image
                src="/images/1.png"
      ...
      <section className="section-divider border-t border-white/10 py-20">
        <div className="mx-auto max-w-6xl px-6">
          <Reveal className="grid items-center gap-10 md:grid-cols-[1fr_1.05fr]">
            <div className="relative h-[360px] overflow-hidden rounded-sm border border-white/10 shadow-[0_25px_70px_rgba(0,0,0,0.4)]">
              <Image
                src="/images/2.png"
